...
from Code_Training.logging import setup_logging
from Code_Training.train import get_args_parser as get_train_args_parser
from Code_Training.run.submit import get_args_parser, submit_jobs
...
class Trainer(object):
    ...
    def __call__(self):
        from Code_Training.train import main as train_main
...
def main():
    description = "Submitit launcher for INCEPT training"
    ...
    submit_jobs(Trainer, args, name="incept:train")
    return 0
