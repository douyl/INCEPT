...
def run_finetune(cfg, args, dev, current_seed):
    ...
    save_path = os.path.join(args.output_dir, "Siena", f"temp_ckpt_{run_id}.pth")
    ...
    if best_epoch != -1 and os.path.exists(save_path):
        ...
        global_save_path = os.path.join(args.output_dir, "Siena", f"{run_id}_FT_seed{current_seed}.pth")
